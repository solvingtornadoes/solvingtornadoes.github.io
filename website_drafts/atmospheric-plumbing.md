...
The vortex is the pipe that solves the accessibility problem. Using the structural properties of $H\_2O$ (the 50/50 bond distribution), the vortex constructs a **structural plasma sheath**.
...
*"A storm is a mechanical event. The Jet Stream provides the pressure potential, the plasma vortex provides the pipe, and the surface moisture provides the leverage. If you remove the pipe (the vortex), you have no storm. If you remove the structural properties of $H\_2O$, you have no pipe. Convection is a myth that ignores the necessity of the conduit."*